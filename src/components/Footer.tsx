    ...
    <footer className="w-full bg-[#F6E7CB] border-t border-[#eee] py-12 pb-6 flex flex-col items-center text-base text-[#555]">
      <div className="centered-container">
        <ul className="list-none flex flex-wrap mb-6 p-0 justify-center">
          <li style={{ margin: '0 16px' }}><a href="#" className="no-underline text-[#555] transition-colors duration-200 hover:text-[#4caf50]" style={{ fontSize: '1.125rem' }}>Reviews</a></li>
          <li style={{ margin: '0 16px' }}><a href="#" className="no-underline text-[#555] transition-colors duration-200 hover:text-[#4caf50]" style={{ fontSize: '1.125rem' }}>About Us</a></li>
          <li style={{ margin: '0 16px' }}><a href="#" className="no-underline text-[#555] transition-colors duration-200 hover:text-[#4caf50]" style={{ fontSize: '1.125rem' }}>FAQ</a></li>
          ...
          <li style={{ margin: '0 16px' }}><a href="#" className="no-underline text-[#555] transition-colors duration-200 hover:text-[#4caf50]" style={{ fontSize: '1.125rem' }}>For Vet Professionals</a></li>
